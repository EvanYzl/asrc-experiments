...
for cid,r in approved.items():
    ...
    if r['placeholder_kind']=='TXT':
        ...
        assert r['value']==r['seed']=='17;29;43' or (cid=='T3.epkg.ssaga.paper_table' and r['seed']=='17' and r['value']=='17 (1/3)' and r['notes'].startswith('INTERIM_SINGLE_SEED:'))
        values.append('\\SetResult{'+cid+'}{'+r['value']+'}')
        continue
    shown=f"{100*float(r['value']):.2f}"
    if r['placeholder_kind']=='PM':
        assert r['seed']=='17;29;43' and r['standard_deviation']
