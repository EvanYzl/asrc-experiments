...
class Connection:
    ...
    def connect(self):
        ...
        self.client.connect('223.109.239.36',port=10316,username='root',password=self.password,look_for_keys=False,allow_agent=False,timeout=20,auth_timeout=20)
    ...
    def download_atomic(self,remote,local):
        ...
        self.sftp.get(remote,str(tmp));os.replace(tmp,local)
