...
def main(args):
    ...
    # ``run.py`` stores both candidate files under model_dir.  Reading the
    # validation file from the caller's working directory made the documented
    # project-root command fail unless users manually copied the file.
