def main(args):
    ...
    src_langs = ['el', 'en', 'es', 'fr', 'ja']
    src_langs.remove(target_lang)

    target_lang = param.lang

    # load data
    data_dir = 'G:\\zhishitupui\\data\\raw\\dmkgc\\datasetdbp5l\\kg'  # where you put kg data
    seed_dir = 'G:\\zhishitupui\\data\\raw\\dmkgc\\datasetdbp5l\\seed_alignlinks'  # where you put seed align links data
    model_dir = 'G:\\zhishitupui\\reproduction\\runs\\strict_baselines_20260905\\smoke\\smoke_kens_v2_dbp5l\\en\\model'  # output
