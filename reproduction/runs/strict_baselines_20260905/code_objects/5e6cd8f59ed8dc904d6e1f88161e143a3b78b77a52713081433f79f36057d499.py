...
def parse_args(args=None):
    ...
    parser.add_argument('--base_align_step', default=5, type=int, help="how many align model epoch to train before switching to knowledge model")
    parser.add_argument('--knowledge_step_ratio', default=2, type=int, help="how many knowledge model epochs for each align epoch")
    ...
    parser.add_argument('--MAX_SAM', default=10000000000, type=int,
                        help="subset of rows for smoke-test debugging; default keeps all data")
    parser.add_argument('--knn_batch_size', default=256, type=int,
                        help="exact brute-force alignment kNN query batch size (memory/runtime only)")
...
def set_params(args):
    ...
    param.k = args.k
    param.max_entity_scan = args.MAX_SAM
    param.knn_batch_size = args.knn_batch_size
