...
def main():
    ...
    for method in ['ATransN','SS-AGA','LSMGA','DMKGC','IMKGC','AlignKGC']:
    ...
    for name,python in [('pytorch','C:/Users/evan/.conda/envs/ai4/python.exe'),('pytorch_with_pyg_overlay','C:/Users/evan/.conda/envs/ai4/python.exe')]:
