...
class MultiModelTester:
    ...
    def __transe_queries(kg, heads, relations):
        entity_matrix = kg.model.layers[3].get_weights()[0]
        relation_matrix = kg.model.layers[4].get_weights()[0]
    ...
    def __test_and_record_results_transe_batched(self, testcases):
        ...
        target_candidates = self.target_kg.model.layers[3].get_weights()[0]
        ...
        for supporter_kg in self.supporter_kgs:
            ...
            if mapped_rows.size:
                ...
                filtered_candidates = (
                    supporter_kg.get_filtered_reordered_embedding_matrix(
                        self.target_kg.num_entity
                    ).reshape([self.target_kg.num_entity, param.dim])
                )
                ...
                mapped_predictions = self.__ranked_lists(
                    supporter_indices, supporter_scores
                )
