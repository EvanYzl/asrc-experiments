...
MODEL_PATH=BASE/'sources/ATransN/src/kge_model.py'
...
def run_domain(args,kg):
    ...
    with ResourceTrace(out/'resources.csv') as trace:
        ...
        atomic_json(out/'FINAL_EVALUATION_FREEZE.json', {'seed':args.seed, 'completed_steps':args.steps, 'selected_step':best_step, 'checkpoint_sha256':sha256(out/'best.pt'), 'selection':'val_select only'})
