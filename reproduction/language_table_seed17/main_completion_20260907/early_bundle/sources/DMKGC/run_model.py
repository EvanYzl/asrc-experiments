...
def main(args):
    ...
    resume_state = load_round_checkpoint(
        args.resume_checkpoint, model, optimizer, scheduler, all_langs, args.device
    )
    if resume_state is not None:
        start_round = resume_state['start_round']
        all_langs = resume_state['ordered_domains']
