                    ...
                    for e3 in e3_set:
                        if e1 + " " + e3 in h_e_p and str(rel1) + ' ' + str(rel2) in h_e_p[e1 + " " + e3]:
                            for rel3 in a[e3]:
                                ...
                                for e4 in e4_set:
                                    if e1 + " " + e4 in ok:
                                        map_add(h_e_p, e1 + ' ' + e4, str(rel1) + ' ' + str(entity2id[e2]) + ' ' + str(rel2) + ' ' +  str(entity2id[e3]) + ' ' + str(rel3),
                                                h_e_p[e1 + " " + e3][str(rel1) + ' ' + str(rel2)] * 1.0 / len(e4_set))
    for e2 in a:
        e_1 = e1
        e_2 = e2
        if e_1 + " " + e_2 in h_e_p:
