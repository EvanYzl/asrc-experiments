...
parser.add_argument('--pretrained-model', default='/home/hyn/work/KGC/SimKGC_my/bert', type=str, metavar='N',
                    help='path to pretrained model')
parser.add_argument('--task', default='FB15k237', type=str, metavar='N',
                    help='dataset name')
parser.add_argument('--train-path', default='/home/hyn/work/KGC/StructKGC/data/FB15k237/train.txt.json', type=str, metavar='N',
                    help='path to training data')
parser.add_argument('--valid-path', default='/home/hyn/work/KGC/StructKGC/data/FB15k237/test.txt.json', type=str, metavar='N',
                    help='path to valid data')
parser.add_argument('--model-dir', default='./checkpoint/FB15k237/', type=str, metavar='N',
...
parser.add_argument('--use-link-graph', default=True,action='store_true',
...
parser.add_argument('--finetune-t', default=False,action='store_true',
                    help='make temperature as a trainable parameter or not')
parser.add_argument('--max-num-tokens', default=50, type=int,
                    help='maximum number of tokens')
parser.add_argument('--use-self-negative', default=False,action='store_true',
...
parser.add_argument('--eval_model_path', default='/home/hyn/work/KGC/StructKGC/checkpoint/fb15k237_muti/checkpoint_epoch9.mdl', type=str, metavar='N',
                    help='path to model, only used for evaluation')
parser.add_argument('--learning_token_path', default='/home/hyn/work/KGC/StructKGC/checkpoint/fb15k237v3/model_best.mdl', type=str, metavar='N',
                    help='path to model, only used for evaluation')
...
parser.add_argument('--ind', default=False,help='inductive setting or not')

parser.add_argument('--rerank-num', default=0, type=int,
                    help='use n-hops node for re-ranking entities, only used during evaluation')
