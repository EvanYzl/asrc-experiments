...
print("实体数量\t关系数量\t实体数量")
print(dataset.get_shape())

model = None
regularizer = None

img_emb = torch.load('../datasets/' + args.dataset + '/img_features.pth') # load modal
text_emb = torch.load('../datasets/' + args.dataset + '/text_features.pth')
exec('model = '+args.model+'(dataset.get_shape(), args.rank, args.init, img_emb, text_emb)')
